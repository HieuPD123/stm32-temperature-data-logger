 ...
 ******************************************************************************
 * @file    oled_ui.h
 * @brief   Giao dien OLED SSD1306 128x64 cho Data Logger nhiet do.
 *          Layout 3 phan: Thoi gian (tren) | Nhiet do + icon (giua) |
 *          Trang thai SD + thanh dung luong (duoi).
 *
 *  ====================  RANH GIOI GIUA 2 PHAN  ============================
 *  - Phan MAN HINH (file nay): chi NHAN du lieu va VE. Khong doc cam bien,
 *    khong dung FatFs, khong biet the SD giao tiep kieu gi.
 *  - Phan THE SD (do nguoi khac lam): tu mount / doc dung luong bang code
 *    cua minh, roi "day" ket qua vao man hinh qua ham OLED_SetSD().
 *
 *  => Hai phan ghep voi nhau CHI qua cac ham setter ben duoi.
 *  =========================================================================
 ******************************************************************************
 */
#ifndef OLED_UI_H
